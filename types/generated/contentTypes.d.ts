...
export interface ApiConsultationConsultation
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    turn: Schema.Attribute.Relation<'oneToOne', 'api::turn.turn'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDatesUsedDatesUsed extends Struct.CollectionTypeSchema {
  collectionName: 'dates_useds';
  info: {
    displayName: 'DatesUsed';
    pluralName: 'dates-useds';
    singularName: 'dates-used';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProfessionalProfessional
  ...
  attributes: {
    ...
    dates_useds: Schema.Attribute.Relation<
      'manyToMany',
      'api::dates-used.dates-used'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTurnTurn extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dates_used: Schema.Attribute.Relation<
      'manyToOne',
      'api::dates-used.dates-used'
    >;
    information: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::turn.turn'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dates-used.dates-used': ApiDatesUsedDatesUsed;
